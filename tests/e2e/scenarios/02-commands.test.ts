...
import { assertRequesterNotifications } from "../helpers/lifecycle.js";
...
describe("Scenario 2: Commands", () => {
  ...
  it("2.3: /team stop cancels an active run", async () => {
    ...
    // Verify requester was notified about cancellation
    assertRequesterNotifications("alpha", { runCanceled: true });
  });
});
